...
const variantClasses = {
  solid:
    "bg-wj-green hover:bg-wj-green-hover text-wj-white border-transparent",
  outline:
    "bg-transparent border border-wj-green text-wj-green hover:bg-wj-green-light",
  ghost:
    "bg-transparent border-transparent text-wj-muted hover:text-wj-text",
  wood:
    "bg-wj-wood hover:bg-[#B5762E] text-wj-white border-transparent",
  dark:
    "bg-wj-dark hover:bg-[#2A2420] text-wj-white border-transparent",
}
